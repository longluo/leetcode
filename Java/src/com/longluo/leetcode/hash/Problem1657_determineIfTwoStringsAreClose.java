...
public class Problem1657_determineIfTwoStringsAreClose {
    ...
    // Counting time: O(n) space: O(C)
    public static boolean closeStrings_opt(String word1, String word2) {
        if (word1.length() != word2.length()) {
            return false;
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("false ?= " + closeStrings_opt("uau", "ssx"));
        System.out.println("true ?= " + closeStrings_opt("cabbba", "abbccc"));
    }
}
