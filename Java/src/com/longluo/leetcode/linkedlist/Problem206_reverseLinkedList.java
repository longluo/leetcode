...
public class Problem206_reverseLinkedList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("[] ?= " + LinkedListNodeUtils.printLinkedList(reverseList2(test1)));
        ...
        System.out.println("[1] ?= " + LinkedListNodeUtils.printLinkedList(reverseList2(test2)));
        ...
        System.out.println("[2,1] ?= " + LinkedListNodeUtils.printLinkedList(reverseList2(test3)));
        ...
        System.out.println("[3,2,1] ?= " + LinkedListNodeUtils.printLinkedList(reverseList2(test4)));
    }
}
