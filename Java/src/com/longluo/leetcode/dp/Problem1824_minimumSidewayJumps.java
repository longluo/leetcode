 ...
 */
public class Problem1824_minimumSidewayJumps {
    ...
    public static void main(String[] args) {
        System.out.println("2 ?= " + minSideJumps(new int[]{0, 1, 2, 3, 0}));
        System.out.println("0 ?= " + minSideJumps(new int[]{0, 1, 1, 3, 3, 0}));
        System.out.println("2 ?= " + minSideJumps(new int[]{0, 2, 1, 0, 3, 0}));
    }
}
