 ...
 */
public class Problem811_subdomainVisitCount {
    ...
    public static void main(String[] args) {
        System.out.println("[9001 leetcode.com, 9001 discuss.leetcode.com, 9001 com]  ?= " + subdomainVisits(new String[]{"9001 discuss.leetcode.com"}));
    }
}
