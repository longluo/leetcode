...
public class Problem944_deleteColumnsToMakeSorted {
    ...
    public static void main(String[] args) {
        System.out.println("0 ?= " + minDeletionSize(new String[]{"a", "b"}));
        System.out.println("1 ?= " + minDeletionSize(new String[]{"cba", "daf", "ghi"}));
        System.out.println("3 ?= " + minDeletionSize(new String[]{"zyx", "wvu", "tsr"}));
    }
}
