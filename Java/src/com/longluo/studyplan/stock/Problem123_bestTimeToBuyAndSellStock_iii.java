 ...
 */
public class Problem123_bestTimeToBuyAndSellStock_iii {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("7 ?= " + maxProfit(new int[]{6, 1, 3, 2, 4, 7}));

        System.out.println("7 ?= " + maxProfit_opt(new int[]{6, 1, 3, 2, 4, 7}));
    }
}
